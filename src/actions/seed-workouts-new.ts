...
function calculateDuration(baseDuration: number, weekNumber: number, exerciseCount: number): number {
...
const workoutTemplates = {
  ...
  fullBodyA: {
    ...
    phase: "foundation",
    exercises: [
      { name: "Squats", baseWeight: 45, baseReps: 8, sets: 3, progressionRate: 1.0, type: "compound" as const },
      { name: "Bench Press", baseWeight: 65, baseReps: 8, sets: 3, progressionRate: 0.8, type: "compound" as const },
      { name: "Bent-over Rows", baseWeight: 55, baseReps: 10, sets: 3, progressionRate: 0.9, type: "compound" as const },
      { name: "Overhead Press", baseWeight: 35, baseReps: 8, sets: 3, progressionRate: 0.6, type: "compound" as const },
      { name: "Planks", baseWeight: 0, baseReps: 30, sets: 3, progressionRate: 0, type: "bodyweight" as const },
    ]
  },
  ...
  fullBodyB: {
    ...
    phase: "foundation",
    exercises: [
      { name: "Deadlifts", baseWeight: 95, baseReps: 5, sets: 3, progressionRate: 1.1, type: "compound" as const },
      { name: "Incline Dumbbell Press", baseWeight: 25, baseReps: 10, sets: 3, progressionRate: 0.7, type: "compound" as const },
      { name: "Lat Pulldowns", baseWeight: 70, baseReps: 12, sets: 3, progressionRate: 0.8, type: "compound" as const },
      { name: "Dumbbell Shoulder Press", baseWeight: 20, baseReps: 10, sets: 3, progressionRate: 0.6, type: "isolation" as const },
      { name: "Bodyweight Squats", baseWeight: 0, baseReps: 15, sets: 2, progressionRate: 0, type: "bodyweight" as const },
    ]
  },
  ...
  upperBody: {
    ...
    phase: "strength",
    exercises: [
      { name: "Bench Press", baseWeight: 75, baseReps: 6, sets: 4, progressionRate: 0.9, type: "compound" as const },
      { name: "Bent-over Rows", baseWeight: 65, baseReps: 8, sets: 4, progressionRate: 1.0, type: "compound" as const },
      { name: "Overhead Press", baseWeight: 45, baseReps: 6, sets: 3, progressionRate: 0.7, type: "compound" as const },
      { name: "Dumbbell Bicep Curls", baseWeight: 15, baseReps: 12, sets: 3, progressionRate: 0.5, type: "isolation" as const },
      { name: "Tricep Dips", baseWeight: 0, baseReps: 8, sets: 3, progressionRate: 0, type: "bodyweight" as const },
      { name: "Face Pulls", baseWeight: 30, baseReps: 15, sets: 3, progressionRate: 0.4, type: "isolation" as const },
    ]
  },
  ...
  lowerBody: {
    ...
    phase: "strength", 
    exercises: [
      { name: "Squats", baseWeight: 65, baseReps: 6, sets: 4, progressionRate: 1.1, type: "compound" as const },
      { name: "Romanian Deadlifts", baseWeight: 75, baseReps: 8, sets: 3, progressionRate: 1.0, type: "compound" as const },
      { name: "Bulgarian Split Squats", baseWeight: 0, baseReps: 10, sets: 3, progressionRate: 0, type: "bodyweight" as const },
      { name: "Calf Raises", baseWeight: 0, baseReps: 20, sets: 3, progressionRate: 0, type: "bodyweight" as const },
      { name: "Leg Curls", baseWeight: 45, baseReps: 12, sets: 3, progressionRate: 0.6, type: "isolation" as const },
      { name: "Walking Lunges", baseWeight: 0, baseReps: 16, sets: 2, progressionRate: 0, type: "bodyweight" as const },
    ]
  },
  ...
  pushDay: {
    ...
    phase: "hypertrophy",
    exercises: [
      { name: "Bench Press", baseWeight: 85, baseReps: 8, sets: 4, progressionRate: 0.8, type: "compound" as const },
      { name: "Incline Dumbbell Press", baseWeight: 35, baseReps: 10, sets: 3, progressionRate: 0.7, type: "compound" as const },
      { name: "Overhead Press", baseWeight: 55, baseReps: 8, sets: 3, progressionRate: 0.6, type: "compound" as const },
      { name: "Lateral Raises", baseWeight: 10, baseReps: 15, sets: 3, progressionRate: 0.3, type: "isolation" as const },
      { name: "Tricep Pushdowns", baseWeight: 40, baseReps: 12, sets: 3, progressionRate: 0.5, type: "isolation" as const },
      { name: "Push-ups", baseWeight: 0, baseReps: 12, sets: 2, progressionRate: 0, type: "bodyweight" as const },
    ]
  },
  ...
  pullDay: {
    ...
    phase: "hypertrophy",
    exercises: [
      { name: "Deadlifts", baseWeight: 135, baseReps: 5, sets: 4, progressionRate: 1.0, type: "compound" as const },
      { name: "Lat Pulldowns", baseWeight: 90, baseReps: 10, sets: 4, progressionRate: 0.8, type: "compound" as const },
      { name: "Bent-over Rows", baseWeight: 85, baseReps: 8, sets: 3, progressionRate: 0.9, type: "compound" as const },
      { name: "Dumbbell Bicep Curls", baseWeight: 25, baseReps: 12, sets: 3, progressionRate: 0.4, type: "isolation" as const },
      { name: "Face Pulls", baseWeight: 40, baseReps: 15, sets: 3, progressionRate: 0.3, type: "isolation" as const },
      { name: "Hammer Curls", baseWeight: 20, baseReps: 12, sets: 2, progressionRate: 0.4, type: "isolation" as const },
    ]
  },
  ...
  legDay: {
    ...
    phase: "hypertrophy",
    exercises: [
      { name: "Squats", baseWeight: 105, baseReps: 8, sets: 4, progressionRate: 1.0, type: "compound" as const },
      { name: "Romanian Deadlifts", baseWeight: 95, baseReps: 10, sets: 3, progressionRate: 0.9, type: "compound" as const },
      { name: "Leg Press", baseWeight: 180, baseReps: 12, sets: 3, progressionRate: 1.2, type: "compound" as const },
      { name: "Leg Curls", baseWeight: 60, baseReps: 15, sets: 3, progressionRate: 0.5, type: "isolation" as const },
      { name: "Calf Raises", baseWeight: 0, baseReps: 25, sets: 4, progressionRate: 0, type: "bodyweight" as const },
      { name: "Walking Lunges", baseWeight: 0, baseReps: 20, sets: 2, progressionRate: 0, type: "bodyweight" as const },
    ]
  },
  ...
  strengthFocus: {
    ...
    phase: "refinement",
    exercises: [
      { name: "Squats", baseWeight: 115, baseReps: 5, sets: 5, progressionRate: 0.8, type: "compound" as const },
      { name: "Bench Press", baseWeight: 95, baseReps: 5, sets: 4, progressionRate: 0.7, type: "compound" as const },
      { name: "Deadlifts", baseWeight: 155, baseReps: 3, sets: 4, progressionRate: 0.9, type: "compound" as const },
      { name: "Overhead Press", baseWeight: 65, baseReps: 5, sets: 3, progressionRate: 0.5, type: "compound" as const },
      { name: "Planks", baseWeight: 0, baseReps: 60, sets: 3, progressionRate: 0, type: "bodyweight" as const },
    ]
  },
  ...
  volumeSession: {
    ...
    phase: "refinement",
    exercises: [
      { name: "Incline Dumbbell Press", baseWeight: 45, baseReps: 12, sets: 4, progressionRate: 0.6, type: "compound" as const },
      { name: "Lat Pulldowns", baseWeight: 110, baseReps: 12, sets: 4, progressionRate: 0.7, type: "compound" as const },
      { name: "Leg Press", baseWeight: 220, baseReps: 15, sets: 4, progressionRate: 1.0, type: "compound" as const },
      { name: "Dumbbell Shoulder Press", baseWeight: 35, baseReps: 10, sets: 3, progressionRate: 0.5, type: "isolation" as const },
      { name: "Dumbbell Bicep Curls", baseWeight: 30, baseReps: 15, sets: 3, progressionRate: 0.3, type: "isolation" as const },
      { name: "Tricep Pushdowns", baseWeight: 55, baseReps: 15, sets: 3, progressionRate: 0.4, type: "isolation" as const },
    ]
  }
};
...
function generateGymJourney(): any[] {
  ...
  dates.forEach((date, index) => {
    ...
    const workout = {
      name: template.name,
      date: date,
      duration: calculateDuration(template.baseDuration, weekNumber, template.exercises.length),
      notes: notes,
      exercises: template.exercises.map((exercise) => ({
        name: exercise.name,
        notes: getExerciseNotes(exercise.name, weekNumber),
        sets: Array(exercise.sets).fill(null).map((_, setIndex) => {
          const weight = exercise.baseWeight > 0 
            ? calculateWeight(exercise.baseWeight, weekNumber, exercise.progressionRate, exercise.type)
            : null;
...
function generateWorkoutNotes(weekNumber: number, phase: string, date: Date): string {
...
export async function seedWorkouts() {
  try {
    ...
    for (const workoutData of gymJourney) {
      ...
      for (let exerciseIndex = 0; exerciseIndex < workoutData.exercises.length; exerciseIndex++) {
    ...
    const totalSets = gymJourney.reduce((total, workout) => 
      total + workout.exercises.reduce((exerciseTotal: number, exercise: any) => 
