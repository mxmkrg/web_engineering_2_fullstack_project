...
export default function ProfilePage() {
  ...
  const handleSavePhysicalInfo = async () => {
    setIsSaving(true);
    try {
      const result = await savePhysicalInfo(
      ...
      if (result.success) {
        ...
        if (result.profile) {
          setProfile((prev) => ({
            ...
            trainingDaysPerWeek:
              result.profile.trainingDaysPerWeek ?? prev.trainingDaysPerWeek,
            sessionDurationMinutes:
              result.profile.sessionDurationMinutes ??
              prev.sessionDurationMinutes,
            createdAt: result.profile.createdAt ?? prev.createdAt,
            updatedAt: result.profile.updatedAt ?? prev.updatedAt,
          }));
        }
  ...
  const handleSaveLimitations = async () => {
    setIsSaving(true);
    try {
      const result = await saveLimitations(
        profile.exerciseLimitations ?? undefined,
      );
      ...
      if (result.success) {
        ...
        if (result.profile) {
          setProfile((prev) => ({
            ...
            id: result.profile.id,
            exerciseLimitations:
              result.profile.exerciseLimitations ?? prev.exerciseLimitations,
            createdAt: result.profile.createdAt ?? prev.createdAt,
            updatedAt: result.profile.updatedAt ?? prev.updatedAt,
          }));
        }
  ...
  return (
    <div className="mx-auto max-w-7xl p-6 animate-fade-in min-h-screen bg-white">
      ...
      <div>
        ...
        <Card
          className=" w-full md:w-[800px] h-[550px] border-blue-500/20 shadow-lg hover:shadow-xl transition-all duration-300 animate-slide-in-from-left bg-white"
            ...
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                ...
                <CardDescription className="text-gray-600">
                  Navigate through different sections of your profile
                </CardDescription>
              </div>
            </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2 group">
                      ...
                      >
                        <SelectTrigger
                          id="gender"
                          className="bg-white border-gray-300 text-gray-900 transition-all duration-200 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        >
                  ...
                  <div className="space-y-6">
                    <div className="space-y-2 group">
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          setProfile({ ...profile, trainingGoal: value })
                        }
                      >
                        <SelectTrigger
                          id="trainingGoal"
                      ...
                      <div className="space-y-2 group">
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setProfile({
                              ...profile,
                              trainingDaysPerWeek: e.target.value
                                ? parseInt(e.target.value)
                                : undefined,
                            })
                          }
                  ...
                  <div className="space-y-2 group">
                    <Textarea
                      ...
                      onChange={(e) =>
                        setProfile({
                          ...profile,
                          exerciseLimitations: e.target.value,
                        })
                      }
                    ...
                    <p className="text-xs text-gray-600 flex items-start gap-1.5">
                      ...
                      <span>
                        List any injuries, physical limitations, or exercises
                        you need to avoid
                      </span>
                    </p>
                  </div>
