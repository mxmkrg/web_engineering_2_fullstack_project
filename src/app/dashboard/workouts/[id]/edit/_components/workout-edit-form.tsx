...
export function WorkoutEditForm({ workoutId, initialData }: WorkoutEditFormProps) {
    ...
    <div className="mx-auto max-w-7xl p-6">
      ...
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-muted-foreground">Update your workout details</p>
        </div>
        ...
        {exercises.length > 0 && (
          <div className="space-y-4">
            {exercises.map((exercise, exerciseIndex) => (
              <div key={exerciseIndex} className="rounded-lg border bg-card p-4">
                <h3 className="text-lg font-semibold mb-4">{exercise.exerciseName}</h3>
