      ...
      return (
        <div key={index} className="mb-2">
          {parts.map((part, partIndex) =>
            partIndex % 2 === 1 ? (
              <strong key={partIndex} className="font-bold text-black">
                {part}
              </strong>
            ) : (
...
export default function FloatingAssistant() {
  ...
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      content: "Hello 👋 I'm your AI Fitness Coach. How can I help?",
    },
  ]);
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            ...
            <div className="px-3 py-3 border-t-2 border-b-2 border-blue-300 bg-gradient-to-b from-blue-50 to-white">
